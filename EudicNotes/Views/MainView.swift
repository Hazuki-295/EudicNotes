...
struct Utils {
    static private func invisibleTemplate(_ firstChar: Character, middleString: String, _ lastChar: Character) -> String {
        return "<span style=\"opacity: 0; position: absolute;\">\(firstChar)</span>" + "\(middleString)" + "<span style=\"opacity: 0; position: absolute;\">\(lastChar)</span>"
    }
