        ...
        GeometryReader { geometry in
            ZStack(alignment: .topTrailing) {
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    SingleNoteView(label: "Third Notes", labelColor: .blue, systemImage: "3.square", noteData: noteData3)
                    SingleNoteView(label: "Fourth Notes", labelColor: .red, systemImage: "4.square", noteData: noteData4)
                }
                .padding(.top, 5)
